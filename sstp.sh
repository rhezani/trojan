...
organizationalunit=www.wifitrojan.my.id
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/rhezani/trojan/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/Endka22/rhezani/trojan/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
